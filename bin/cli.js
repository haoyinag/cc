...
function runStatus() {
  ...
  console.log('[cmdcc] 预计应复制的脚本:');
  for (const file of ASSET_FILES) {
    console.log(`  - ${file}`);
  }

  console.log('[cmdcc] 已托管的 shell 初始化文件:');
